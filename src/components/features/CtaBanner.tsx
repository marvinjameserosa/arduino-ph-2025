    ...
    <div className='relative flex flex-col items-center justify-center gap-8 py-10 h-fit'>
      ...
      <div className='flex flex-col items-center justify-center gap-0'>
          <div className='flex gap-4 items-center justify-center max-w-[80%]'>
              ...
              <h4 className='uppercase text-[clamp(18px,2.5vw,51.99px)] text-center'>PUP Gym, Polytechnic University of the Philippines Main Campus</h4>
          </div>
          <Heading text='March 23, 2025' className='text-[clamp(100px,21.28vw,400px)] tracking-normal uppercase' glowAll />
          <h2 
            className='text-[clamp(30px,3.85vw,74px)] px-2 italic text-center bg-clip-text text-transparent bg-gradient-cta max-w-[80%] lg:max-w-full'
          >
            Be Part of the Movement! Join and Celebrate Innovation with Us!
          </h2>
      </div>
      <Button className='py-3 px-6 lg:py-6 lg:px-12 bg-none'>
          <p className='text-xs font-medium lg:font-bold lg:text-xl uppercase'>Register Now</p>
      </Button>
    </div>
  )
}
